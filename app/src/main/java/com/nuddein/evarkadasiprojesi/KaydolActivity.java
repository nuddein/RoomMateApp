...
public class KaydolActivity extends AppCompatActivity {
    ...
    EditText edit_kullanicAdi, edit_Ad, edit_Email, edit_Sifre ;
                    ...
                    .addOnCompleteListener(KaydolActivity.this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if(task.isSuccessful()) {
                                ...
                                // User'a doğrulama e-postası gönder
                                            ...
                                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        Toast.makeText(KaydolActivity.this, "Doğrulama e-postası gönderildi", Toast.LENGTH_LONG).show();
                                                    } else {
                                                        // Doğrulama e-postası gönderilirken hata oluştu
                                                        Toast.makeText(KaydolActivity.this, "Doğrulama e-postası gönderilirken bir hata oluştu", Toast.LENGTH_LONG).show();
                                                    }
                                                }
                                            });
                                }

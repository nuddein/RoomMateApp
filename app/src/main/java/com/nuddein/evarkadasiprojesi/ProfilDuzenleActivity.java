...
import com.nuddein.evarkadasiprojesi.databinding.ActivityProfilDuzenleBinding;
...
public class ProfilDuzenleActivity extends AppCompatActivity {
    ...
    EditText edit_Ad, edit_kullaniciAdi,
            edit_mail, edit_telNo, edit_mesafe, edit_sure;





    CheckBox chechbox_arkadasAra, chechbox_evAra, chechbox_arama;
   ...
   // private StorageReference storageReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edit_mesafe = findViewById(R.id.edit_text_mesafe_profilDuzenleActivity);
        edit_sure = findViewById(R.id.edit_text_sure_profilDuzenleActivity);
        ...
        chechbox_arkadasAra = findViewById(R.id.checkbox_arkadasAriyor_profilDuzenleActivity);
        chechbox_evAra = findViewById(R.id.checkbox_evArior_profilDuzenleActivity);
        chechbox_arama = findViewById(R.id.checkbox_aramiyor_profilDuzenleActivity);
                ...
                txt_kaydet.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        profiliGuncelle(edit_Ad.getText().toString(), edit_kullaniciAdi.getText().toString(),
                                ...
                                chechbox_arkadasAra, chechbox_evAra, chechbox_arama, edit_mesafe.getText().toString(), edit_sure.getText().toString()) ;
                    }
                });
            }
            @Override
    ...
    private void profiliGuncelle(String ad, String kullaniciAdi,
                                 ...
                                 CheckBox ch_doktora, String mesafe, String sure) {
        ...
        kullaniciGuncellemeHahsmap.put("mesafe", mesafe);
        kullaniciGuncellemeHahsmap.put("sure", sure);
